        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title">Tambah Pemotongan Pajak</h3>
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="mb-10">
                            <label for="file_excel" class="form-label">Data Pemotongan Pajak Dalam Format (.xlsx)</label>
                            <a class="btn btn-sm btn-success mb-5"
                                href="{{ asset('template-excel/template_pemotongan_pajak.xlsx') }}" target="_blank"
...
@section('script')
    <script>
        ...
        $(document).on('click', ".btn-submit-import", function(e) {
            ...
            control.submitFormMultipartData('/pajak/laporan/import-pemotongan-pajak', 'Tambah',
                'Pemotongan Pajak',
                'POST');
        ...
        $(document).on('click', '.button-update', function(e) {
            ...
            let url = '/pajak/laporan/show-pemotongan-pajak/' + uuid;
            control.overlay_form('Update', 'Pemotongan Pajak', url);
        });

        $(document).on('submit', ".form-data", function(e) {
            e.preventDefault();
            let uuid = $("input[name='uuid']").val();
            control.submitFormMultipartData('/pajak/laporan/update-pemotongan-pajak/' + uuid, 'Update',
                'Pemotongan Pajak', 'POST');
        });

        $(document).on('click', '.button-delete', function(e) {
            e.preventDefault();
            let url = '/pajak/laporan/delete-pemotongan-pajak/' + $(this).attr('data-uuid');
        ...
        const initDatatable = async () => {
            ...
            $('#kt_table_data').DataTable({
                ...
                processing: true,
                ajax: '/pajak/laporan/get-pemotongan-pajak',
                columns: [{
                    data: null,
                ...
                columnDefs: [{
                    ...
                    render: function(data, type, full, meta) {
                        return `
                                ...
                                <a href="javascript:;" type="button" data-uuid="${data}" data-label="Pemotongan Pajak" class="btn btn-danger button-delete btn-icon btn-sm">
