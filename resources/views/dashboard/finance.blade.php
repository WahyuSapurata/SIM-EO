                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center gap-5">
                                ...
                                <div>
                                    ...
                                    <div class="fs-5">{{ 'Rp. ' . number_format($subTotal, 0, ',', '.') }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card shadow-sm">
                        <div class="card-body">
                            <div class="d-flex align-items-center gap-5">
                                ...
                                <div>
                                    <div class="fs-6">Pengajuan</div>
                                    <div class="fs-5">{{ 'Rp. ' . number_format($totalRealCost, 0, ',', '.') }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card shadow-sm">
                        <div class="card-body">
                            <div class="d-flex align-items-center gap-5">
                                ...
                                <div>
                                    <div class="fs-6">Keuntungan</div>
                                    <div class="fs-5">{{ 'Rp. ' . number_format($keuntungan, 0, ',', '.') }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
