...
@section('button')
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack gap-2">
        ...
        <div class="d-flex align-items-center gap-2 gap-lg-3">
            ...
            <button type="button" id="export-excelPO" class="btn btn-sm btn-success d-flex align-items-center gap-1">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
...
@section('script')
    <script>
            ...
            render: function(data, type, full, meta) {
                ...
                if (hasil) {
                    ...
                    <a href="javascript:;" type="button" data-uuid="${data}" data-kt-drawer-show="true" data-kt-drawer-target="#side_form" class="btn btn-primary button-update btn-icon btn-sm ${status_client ? 'disabled-link' : ''}">
                        ...
                        <a href="javascript:;" type="button" data-uuid="${data}" data-label="Real Cost" class="btn btn-danger button-delete btn-icon btn-sm ${status_client ? 'disabled-link' : ''}">
                        ...
                        <rect x="0.5" width="24" height="24" fill="white"/>
                                ...
                                <input class="checkbox-uuid ${status_client ? 'disabled-link' : ''}" type="checkbox" data-uuid="${data}" onclick="handleCheckboxClick('${data}')" />
                            `;
                }
            },
        }];
        ...
        $('#export-excelPO').click(function(e) {
            e.preventDefault();
            window.open(`/procurement/export-realCost/${lastPart}`, "_blank");
        });
    </script>
@endsection
