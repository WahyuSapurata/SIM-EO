...
@section('button')
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack gap-2">
        ...
        <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
            ...
            <button type="button" id="cetakButton" class="btn btn-sm btn-info d-flex align-items-center gap-1"
        ...
        <div class="d-flex align-items-center gap-2 gap-lg-3">
            <button type="button" class="btn btn-sm btn-success d-flex align-items-center gap-1" data-bs-toggle="modal"
        ...
        <!--begin::Actions-->
        <div class="d-flex align-items-center gap-2 gap-lg-3">
            <button type="button" id="export-excel" class="btn btn-sm btn-danger d-flex align-items-center gap-1">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        d="M9.14933 1.3335H4.44445C3.97295 1.3335 3.52076 1.50909 3.18737 1.82165C2.85397 2.13421 2.66667 2.55814 2.66667 3.00016V13.0002C2.66667 13.4422 2.85397 13.8661 3.18737 14.1787C3.52076 14.4912 3.97295 14.6668 4.44445 14.6668H11.5556C12.0271 14.6668 12.4792 14.4912 12.8126 14.1787C13.146 13.8661 13.3333 13.4422 13.3333 13.0002V5.256C13.3333 5.035 13.2396 4.82307 13.0729 4.66683L9.77778 1.57766C9.61112 1.42137 9.38506 1.33354 9.14933 1.3335ZM9.33333 4.25016V2.5835L12 5.0835H10.2222C9.98648 5.0835 9.76038 4.9957 9.59368 4.83942C9.42698 4.68314 9.33333 4.47118 9.33333 4.25016ZM6.11911 6.90016L8 9.016L9.88089 6.89933C9.95645 6.81446 10.0649 6.76121 10.1823 6.75128C10.2998 6.74136 10.4166 6.77558 10.5071 6.84641C10.5976 6.91725 10.6544 7.0189 10.665 7.129C10.6756 7.23909 10.6391 7.34863 10.5636 7.4335L8.57867 9.66683L10.5636 11.9002C10.6357 11.9854 10.6694 12.0936 10.6575 12.2018C10.6456 12.3101 10.5891 12.4096 10.4999 12.4792C10.4108 12.5489 10.2961 12.5831 10.1805 12.5745C10.0648 12.566 9.95729 12.5154 9.88089 12.4335L8 10.3177L6.11911 12.4343C6.04355 12.5192 5.93513 12.5725 5.81769 12.5824C5.70025 12.5923 5.58342 12.5581 5.49289 12.4872C5.40236 12.4164 5.34556 12.3148 5.33497 12.2047C5.32439 12.0946 5.36089 11.985 5.43645 11.9002L7.42133 9.66683L5.43645 7.4335C5.39742 7.39168 5.36772 7.34297 5.34907 7.29023C5.33043 7.2375 5.32322 7.18179 5.32788 7.12641C5.33254 7.07102 5.34896 7.01706 5.37619 6.96772C5.40342 6.91837 5.4409 6.87462 5.48642 6.83906C5.53195 6.80349 5.58461 6.77681 5.64129 6.76061C5.69798 6.7444 5.75755 6.73898 5.8165 6.74467C5.87545 6.75037 5.93259 6.76706 5.98456 6.79376C6.03653 6.82046 6.08228 6.85664 6.11911 6.90016Z"
                        fill="white" />
...
@section('content')
    ...
    <button type="button" id="button-event" class="btn btn-primary d-none" data-bs-toggle="modal"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Pilih Event Terlebih Dahulu</h1>
    ...
    <div class="modal fade" tabindex="-1" id="kt_modal_1">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title">Import Penjualan</h3>
                ...
                <div class="modal-body">
                    <form class="form-data" enctype="multipart/form-data">
                        ...
                        <div class="mb-10">
                            <label for="file_excel" class="form-label d-block">Data Penjualan Dalam Format (.xlsx)</label>
                            <a class="btn btn-sm btn-success mb-5"
                                href="{{ asset('template-excel/template_penjualan.xlsx') }}" target="_blank"
                                ...
                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                    ...
                                    <path
                                        d="M9.14933 1.3335H4.44445C3.97295 1.3335 3.52076 1.50909 3.18737 1.82165C2.85397 2.13421 2.66667 2.55814 2.66667 3.00016V13.0002C2.66667 13.4422 2.85397 13.8661 3.18737 14.1787C3.52076 14.4912 3.97295 14.6668 4.44445 14.6668H11.5556C12.0271 14.6668 12.4792 14.4912 12.8126 14.1787C13.146 13.8661 13.3333 13.4422 13.3333 13.0002V5.256C13.3333 5.035 13.2396 4.82307 13.0729 4.66683L9.77778 1.57766C9.61112 1.42137 9.38506 1.33354 9.14933 1.3335ZM9.33333 4.25016V2.5835L12 5.0835H10.2222C9.98648 5.0835 

    ...
    <div class="modal fade" tabindex="-1" id="kt_modal_3">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title">Selesaikan Tugas</h3>
                ...
                <div class="modal-body">
                    <form class="form-data" enctype="multipart/form-data">
                        ...
                        <input type="hidden" id="uuid_disabled" name="uuid_client">

                        <div class="bg-warning p-3 py-2  rounded" style="width: max-content;">Peringatan!!</div>
                        <div>Apakah anda betul akan menyelesaikan pekerjaan?, maka semua data tidak dapat lagi di lakukan
                            aksi.</div>
                        <div class="separator separator-dashed mt-8 mb-5"></div>
                        <div class="d-flex gap-5">
                            <button type="submit"
                                class="btn btn-primary btn-sm btn-submit-disabled d-flex align-items-center"><i
                                    class="bi bi-send"></i> Lanjutkan</button>
                            <button type="reset" data-bs-dismiss="modal"
                                class="btn mr-2 btn-light btn-sm d-flex align-items-center"
                                style="background-color: #ea443e65; color: #EA443E"><i class="bi bi-trash-fill"
                                    style="color: #EA443E"></i>Batal</button>
            ...
            <div class="card-body hover-scroll-overlay-y">
                <form class="form-data">
                    ...
                    <div class="mb-10">
                        ...
                        <input type="number" id="freq" class="form-control kt_datepicker_7" name="freq">
                    ...
                    <div class="mb-10">
                        ...
                        <small class="text-danger harga_satuan_error"></small>
                    </div>
...
@section('script')
    <script>
            ...
            try {
                ...
                if (res.success === true) {
                    ...
                    $.each(res.data, function(x, y) {
                        html += `<option value="${y.uuid}">${y.event}</option>`;
                    });
                    ...
                    $('#event_select').on('change', function() {
                        ...
                        formData.append('uuid_client', selectedUuid);
                        $('#uuid_client_import').val(selectedUuid);
                        // someFunction(selectedUuid);
                        $('#staticBackdrop_modal').modal('hide');

                        uuidSelected(selectedUuid);
                        getFee(selectedUuid);
                        checkClient(selectedUuid);
                        formDataFee.append('uuid_client', selectedUuid);
                        $('#uuid_fee_penjualan').val(selectedUuid);

                        $('#uuid_disabled').val(selectedUuid);
                        formDisable.append('uuid_client', selectedUuid);
                    ...
                    $(document).on('submit', ".form-data", function(e) {
                        ...
                        if (type == 'add') {
                            control.submitForm('/procurement/add-penjualan', 'Tambah',
                                'Penjualan',
                                'POST', formData);
                        } else {
                            let uuid = $("input[name='uuid']").val();
                            control.submitForm('/procurement/update-penjualan/' + uuid,
                                'Update',
                                'Penjualan', 'POST', formData);
                        }
                    });
                    ...
                    $(document).on('click', ".btn-submit-import", function(e) {
                        ...
                        control.submitFormMultipartData('/procurement/add-import-penjualan', 'Tambah',
                            'Penjualan',
                            'POST');
        ...
        const checkFee = (checkFee, selectedUuid) => {
            $('#export-excel').click(function(e) {
                ...
                if (checkFee === null) {
                    ...
                    window.open(`/procurement/export-excel/${selectedUuid}`, "_blank");
                }
            });
        }
        ...
        const getFee = (selectedUuid) => {
            $.ajax({
                ...
                success: function(res) {
                    if (res.success === true) {
                        checkFee(res.data, selectedUuid);
                        if (res.data != null) {
        ...
        const checkClient = (selectedUuid) => {
            $.ajax({
                url: '/procurement/get-dataclient',
                method: 'GET',
                async: false, // Pastikan request berjalan secara sinkron
        ...
        $(document).on('click', ".btn-submit-disabled", function(e) {
            e.preventDefault();

            let uuid_disabled = $('#uuid_disabled').val();
            control.submitForm('/procurement/disabled-data', 'Tambah',
                'Disabled Data',
                'POST', formDisable);
            $('#kt_modal_3').modal('hide');
            checkClient(uuid_disabled);
        });
        ...
        $(document).on('click', '.button-update', function(e) {
            e.preventDefault();
            let url = '/procurement/show-penjualan/' + $(this).attr('data-uuid');
            control.overlay_form('Update', 'Penjualan', url);
        })

        $(document).on('click', '.button-delete', function(e) {
            e.preventDefault();
            let url = '/procurement/delete-penjualan/' + $(this).attr('data-uuid');
        ...
        let columnDefs = [{
            ...
            render: function(data, type, full, meta) {
                return `
                                    <a href="javascript:;" type="button" data-uuid="${data}" data-kt-drawer-show="true" data-kt-drawer-target="#side_form" class="btn btn-primary button-update btn-icon btn-sm ${status_client ? 'disabled-link' : ''}">
                                    ...
                                    <a href="javascript:;" type="button" data-uuid="${data}" data-label="Penjualan" class="btn btn-danger button-delete btn-icon btn-sm ${status_client ? 'disabled-link' : ''}">
