            ...
            <div class="card-body hover-scroll-overlay-y">
                <form class="form-data" enctype="multipart/form-data">
                    ...
                    <div class="mb-10">
                        ...
                        <input type="text" id="cabang" class="form-control" name="cabang">
                        <small class="text-danger cabang_error"></small>
                    </div>

                    <div class="mb-10">
                        <label class="form-label">Atas Nama</label>
                        <input type="text" id="atas_nama" class="form-control" name="atas_nama">
                        <small class="text-danger atas_nama_error"></small>
                    </div>
...
@section('script')
    <script>
        ...
        $(document).on('click', '#button-side-form', function() {
            control.overlay_form('Tambah', 'Data Bank');
        })
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            if (type == 'add') {
                control.submitFormMultipartData('/admin/master-data/add-databank', 'Tambah',
                    'Data Bank',
                    'POST');
            } else {
                let uuid = $("input[name='uuid']").val();
                control.submitFormMultipartData('/admin/master-data/update-databank/' + uuid, 'Update',
                    'Data Bank', 'POST');
            }
        });
        ...
        $(document).on('click', '.button-update', function(e) {
            e.preventDefault();
            let url = '/admin/master-data/show-databank/' + $(this).attr('data-uuid');
            control.overlay_form('Update', 'Data Bank', url);
        })

        $(document).on('click', '.button-delete', function(e) {
            e.preventDefault();
            let url = '/admin/master-data/delete-databank/' + $(this).attr('data-uuid');
        ...
        let columnDefs = [{
            ...
            render: function(data, type, full, meta) {
                ...
                <a href="javascript:;" type="button" data-uuid="${data}" data-label="Data Bank" class="btn btn-danger button-delete btn-icon btn-sm">
        ...
        $(function() {
            control.initDatatable('/admin/master-data/get-databank', columns, columnDefs);
        })
    </script>
@endsection
