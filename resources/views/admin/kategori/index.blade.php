...
@section('script')
    <script>
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            if (type == 'add') {
                control.submitFormMultipartData('/admin/master-data/add-kategori', 'Tambah',
                    'Data Kategori',
                    'POST');
            } else {
                let uuid = $("input[name='uuid']").val();
                control.submitFormMultipartData('/admin/master-data/update-kategori/' + uuid, 'Update',
                    'Data Kategori', 'POST');
            }
        });
        ...
        $(document).on('click', '.button-update', function(e) {
            e.preventDefault();
            let url = '/admin/master-data/show-kategori/' + $(this).attr('data-uuid');
            control.overlay_form('Update', 'Data Kategori', url);
        })

        $(document).on('click', '.button-delete', function(e) {
            e.preventDefault();
            let url = '/admin/master-data/delete-kategori/' + $(this).attr('data-uuid');
        ...
        $(function() {
            control.initDatatable('/admin/master-data/get-kategori', columns, columnDefs);
        })
    </script>
@endsection
