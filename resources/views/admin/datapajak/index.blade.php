            ...
            <div class="card-body hover-scroll-overlay-y">
                <form class="form-data" enctype="multipart/form-data">
                    ...
                    <div class="mb-10">
                        ...
                        <input type="text" id="pajak" class="form-control" name="pajak">
...
@section('script')
    <script>
        ...
        $(document).on('click', '#button-side-form', function() {
            control.overlay_form('Tambah', 'Persentase Pajak');
        })
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            if (type == 'add') {
                control.submitFormMultipartData('/admin/master-data/add-datapajak', 'Tambah',
                    'Persentase Pajak',
                    'POST');
            } else {
                let uuid = $("input[name='uuid']").val();
                control.submitFormMultipartData('/admin/master-data/update-datapajak/' + uuid, 'Update',
                    'Persentase Pajak', 'POST');
            }
        });

        $(document).on('click', '.button-update', function(e) {
            e.preventDefault();
            let url = '/admin/master-data/show-datapajak/' + $(this).attr('data-uuid');
            control.overlay_form('Update', 'Persentase Pajak', url);
        })

        $(document).on('click', '.button-delete', function(e) {
            e.preventDefault();
            let url = '/admin/master-data/delete-datapajak/' + $(this).attr('data-uuid');
        ...
        let columnDefs = [{
            ...
            render: function(data, type, full, meta) {
                ...
                <a href="javascript:;" type="button" data-uuid="${data}" data-label="Persentase Pajak" class="btn btn-danger button-delete btn-icon btn-sm">
        ...
        $(function() {
            control.initDatatable('/admin/master-data/get-datapajak', columns, columnDefs);
        })
    </script>
@endsection
