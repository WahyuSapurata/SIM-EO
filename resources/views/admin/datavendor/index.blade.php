        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title">Tambah Item Vendor</h3>
                ...
                <div class="modal-body">
                    <form class="" enctype="multipart/form-data">
                        ...
                        <input type="hidden" id="uuid_vendor_import" name="uuid_vendor">

                        <div class="mb-10">
                            <label for="file_excel" class="form-label d-block">Data Item Vendor Dalam Format (.xlsx)</label>
                            <a class="btn btn-sm btn-success mb-5"
                                href="{{ asset('template-excel/template_data_vendor.xlsx') }}" target="_blank"
            ...
            <div class="card-body hover-scroll-overlay-y">
                <form class="form-data" enctype="multipart/form-data">
                    ...
                    <div class="mb-10">
                        ...
                        <input type="text" id="nama_owner" class="form-control" name="nama_owner">
                        <small class="text-danger nama_owner_error"></small>
                    </div>

                    <div class="mb-10">
                        <label class="form-label">Nama Perusahaan</label>
                        <input type="text" id="nama_perusahaan" class="form-control" name="nama_perusahaan">
                        <small class="text-danger nama_perusahaan_error"></small>
                    </div>
...
@section('script')
    <script>
        ...
        $(document).on('click', '#button-side-form', function() {
            control.overlay_form('Tambah', 'Vendor');
        })
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            if (type == 'add') {
                control.submitFormMultipartData('/admin/master-data/add-datavendor', 'Tambah',
                    'Vendor',
                    'POST');
            } else {
                let uuid = $("input[name='uuid']").val();
                control.submitFormMultipartData('/admin/master-data/update-datavendor/' + uuid, 'Update',
                    'Vendor', 'POST');
            }
        });
        ...
        $(document).on('click', '.button-update', function(e) {
            e.preventDefault();
            let url = '/admin/master-data/show-datavendor/' + $(this).attr('data-uuid');
            control.overlay_form('Update', 'Vendor', url);
        })

        $(document).on('click', '.button-delete', function(e) {
            e.preventDefault();
            let url = '/admin/master-data/delete-datavendor/' + $(this).attr('data-uuid');
        ...
        let columnDefs = [{
            ...
            render: function(data, type, full, meta) {
                return `
                <a href="/admin/dataitemvendor/${data}" type="button" data-uuid="${data}" class="btn btn-warning btn-icon btn-sm">
                    <svg xmlns="http://www.w3.org/2000/svg" height="16" width="14" viewBox="0 0 448 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--> <style>svg{fill:#FFFFFF}</style> <path d="M96 0C43 0 0 43 0 96V416c0 53 43 96 96 96H384h32c17.7 0 32-14.3 32-32s-14.3-32-32-32V384c17.7 0 32-14.3 32-32V32c0-17.7-14.3-32-32-32H384 96zm0 384H352v64H96c-17.7 0-32-14.3-32-32s14.3-32 32-32zm32-240c0-8.8 7.2-16 16-16H336c8.8 0 16 7.2 16 16s-7.2 16-16 16H144c-8.8 0-16-7.2-16-16zm16 48H336c8.8 0 16 7.2 16 16s-7.2 16-16 16H144c-8.8 0-16-7.2-16-16s7.2-16 16-16z"/></svg>
                </a>
                ...
                <a href="javascript:;" type="button" data-uuid="${data}" data-label="Vendor" class="btn btn-danger button-delete btn-icon btn-sm">
        ...
        $(function() {
            control.initDatatable('/admin/master-data/get-datavendor', columns, columnDefs);
        })
    </script>
@endsection
