            ...
            <div class="card-body hover-scroll-overlay-y">
                <form class="form-data" enctype="multipart/form-data">
                    ...
                    <div class="mb-10">
                        ...
                        <input type="text" id="spsifikasi" class="form-control" name="spsifikasi">
                        <small class="text-danger spsifikasi_error"></small>
                    </div>
                    ...
                    <div class="mb-10">
                        ...
                        <input type="text" id="qty_satuan" class="form-control" name="qty_satuan">
                        <small class="text-danger qty_satuan_error"></small>
                    </div>
                    ...
                    <div class="mb-10">
                        <label class="form-label">Satuan</label>
                        <input type="text" id="freq_satuan" class="form-control" name="freq_satuan">
                        <small class="text-danger freq_satuan_error"></small>
                    </div>
...
@section('script')
    <script>
        ...
        $(document).on('click', '#button-side-form', function() {
            control.overlay_form('Tambah', 'Data Operasiona Kantor');
        })
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            if (type == 'add') {
                ...
                control.submitFormMultipartData('/admin/data-operasional/update-operasionalkantor/' + uuid,
                    'Update',
            ...
            $('#kt_table_data').DataTable({
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        className: 'text-center',
                        render: function(data, type, row, meta) {
                            const value = numeral(row.harga_satuan * row.qty * row.freq).format(
                                '0,0'); // Format to rupiah
                            return 'Rp ' + value;
                        }
                    },
                ...
                columnDefs: [{
                    ...
                    render: function(data, type, full, meta) {
                        if (full.sisa_tagihan) {
                            ...
                            <a href="javascript:;" type="button" data-uuid="${data}" data-label="Data Operasiona Kantor" class="btn btn-danger button-delete btn-icon btn-sm">
                                <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                rowGroup: {
                    ...
                    startRender: function(rows, group) {
                        if (!groupedData[group]) {
                            ...
                            groupedData[group]++;
                            return null; // Skip rendering for subsequent rows with the same group
                        }
                    },
                },
        ...
        $(function() {
            control.push_select_kategori('/admin/master-data/get-kategori', '#from_select');
            initDatatable();
        });

        $('#export-excel').click(function(e) {
            e.preventDefault();
            window.open(`/admin/data-operasional/export-operasionalkantor`, "_blank");
        });
    </script>
@endsection
