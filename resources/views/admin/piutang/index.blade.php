...
@section('script')
    <script>
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            formData.append('uuid_invoice', uuid_piutang);
            control.submitForm('/admin/Utang-piutang/update-piutang/' + uuid_piutang, 'Tambah',
                'Piutang', 'POST', formData);
        });
        ...
        const initDatatable = async () => {
            ...
            $('#kt_table_data').DataTable({
                ...
                processing: true,
                ajax: '/admin/Utang-piutang/get-piutang',
                columns: [{
                    data: null,
        ...
        $('#export-excel').click(function(e) {
            e.preventDefault();
            window.open(`/admin/Utang-piutang/export-piutang`, "_blank");
        });
    </script>
@endsection
