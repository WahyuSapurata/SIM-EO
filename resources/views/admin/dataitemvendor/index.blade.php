...
@section('script')
    <script>
        ...
        $('#uuid_vendor_import').val(lastPart);
        formData.append('uuid_vendor', lastPart);
        ...
        $(document).on('click', '#button-side-form', function() {
            control.overlay_form('Tambah', 'Item Vendor');
        })

        $(document).on('click', '.button-update', function(e) {
            e.preventDefault();
            let url = '/admin/show-dataitemvendor/' + $(this).attr('data-uuid');
            control.overlay_form('Update', 'Item Vendor', url);
        })

        $(document).on('click', '.button-delete', function(e) {
            e.preventDefault();
            let url = '/admin/delete-dataitemvendor/' + $(this).attr('data-uuid');
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            // Menambahkan nilai 'uuid_vendor' ke FormData
            ...
            if (type == 'add') {
                control.submitForm('/admin/add-dataitemvendor', 'Tambah',
                    'Item Vendor',
                    'POST', formData);
            } else {
                let uuid = $("input[name='uuid']").val();
                control.submitForm('/admin/update-dataitemvendor/' + uuid,
                    'Update',
                    'Item Vendor', 'POST', formData);
            }
        });
        ...
        $(document).on('click', ".btn-submit-import", function(e) {
            ...
            control.submitFormMultipartData('/admin/add-import-vendor', 'Tambah',
                'Item Vendor',
                'POST');
        ...
        let columnDefs = [{
            ...
            render: function(data, type, full, meta) {
                return `
                                    ...
                                    <a href="javascript:;" type="button" data-uuid="${data}" data-label="Item Vendor" class="btn btn-danger button-delete btn-icon btn-sm">
        ...
        $(function() {
            control.initDatatable(
                '/admin/get-dataitemvendor/' + lastPart, columns,
                columnDefs);
        })
    </script>
@endsection
