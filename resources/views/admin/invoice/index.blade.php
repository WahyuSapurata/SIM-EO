            ...
            <div class="card-body hover-scroll-overlay-y">
                <form class="form-data" enctype="multipart/form-data">
                    ...
                    <div class="mb-10">
                        ...
                        <input type="number" id="no_invoice" class="form-control" name="no_invoice">
                    ...
                    <div class="mb-10">
                        ...
                        <select name="client" class="form-select" data-control="select2" id="from_select_client"
                            data-placeholder="Pilih jenis inputan">
                        </select>
...
@section('script')
    <script>
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            if (type == 'add') {
                ...
                control.submitWindow(`/admin/add-export-invoice?${queryString}`, 'Tambah', 'Invoice');
            } else {
    ...
    //         `;
        ...
        $(function() {
            ...
            control.push_select_client('/procurement/get-dataclient', '#from_select_client');
