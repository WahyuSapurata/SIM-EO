...
<body>
    <div class="container">
        <div style="display: flex; align-items: center; border-bottom: 4px solid #0a3e62; padding-bottom: 20px">
            <div style="width: 100%">
                <img src="https://raw.githubusercontent.com/WahyuSapurata/foto/main/logo-mks.png" alt="">
            </div>
            <div style="width: 100%; font-size: 18px; text-align: end">
                <div style="font-size: 20px; font-weight: bold">PT. MAHAKARYA KREASI SOLUSI</div>
                <div>Alamat: Metropolitan Tower, Level 13-A
                    Jl. TB Simatupang 14, RT.010/RW.04,Cilandak
                    Jakarta Selatan 12430</div>
                <div>Phone : (021) – 2708560</div>
                <div>mahakarya.kreasisolusi@gmail.com</div>
            </div>
        </div>
        ...
        <div style="width: 100%; margin-top: 30px">
            <div style="display: flex">
                <div style="width: 100%; font-weight: bold">
                    <div
                        style="font-size: 23px; border: 1px solid #000; padding: 8px; background-color: #0a3e62; width: 350px; color: #FFFFFF">
                        INVOICE
                    </div>
        ...
        <div style="width: 100%; margin-top: 175px; height: 10px; border: 1px solid; background-color: #0a3e62"></div>
    </div>
</body>
