    ...
    <script>
        ...
        const initDatatable = async () => {
            ...
            $('#kt_table_data').DataTable({
                ...
                processing: true,
                ajax: '/admin/data-invoice/get-invoice',
                columns: [{
                        data: null,
                    ...
                    render: function(data, type, full, meta) {
                        ...
                        `;
                            ...
                            return `
                                    ...
                                    <a href="javascript:;" type="button" data-uuid="${data}" class="btn btn-warning btn-icon btn-sm" id="reload-data" data-bs-toggle="modal" data-bs-target="#kt_modal_1">
                ...
                footerCallback: function(row, data, start, end, display) {
                    ...
                    api.column(9, {
                        ...
                        // Harga satuan diubah menjadi float dan dikalikan dengan freq
                        let tagihan = value.tagihan == null ? 0 : value.tagihan;
        ...
        $('#export-excel').click(function(e) {
            e.preventDefault();
            window.open(`/admin/data-invoice/export-persetujuaninvoice`, "_blank");
        });
    </script>
@endsection
