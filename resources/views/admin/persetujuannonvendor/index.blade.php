...
@section('script')
    <script>
        ...
        $(document).on('click', '.button-reload', function(e) {
            e.preventDefault();
            control.submitData('/admin/persetujuan-po/reload-pesetujuannonvendor/' + $(this).attr('data-uuid'),
                'Reload', 'Persetujuan Po Non Vendor', 'GET');
        })
        ...
        let columnDefs = [{
            ...
            render: function(data, type, full, meta) {
                ...
                <a href="javascript:;" type="button" data-uuid="${full.uuid_realCost}" data-label="Persetujuan Po Non Vendor" class="btn btn-warning button-reload btn-icon btn-sm">
