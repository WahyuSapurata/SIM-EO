...
@section('script')
    <script>
        ...
        $(document).on('click', '#button-reload', function(e) {
            ...
            formDataReload.append('uuid_realCost', $('#uuid_realCost').val());
            formDataReload.append('ket', $('#ket').val());
            control.submitForm('/admin/persetujuan-po/reload-pesetujuannonvendor',
                'Reload', 'Persetujuan po non vendor', 'POST', formDataReload);
        })
                ...
                @if ($role === 'finance' || $role === 'direktur')
                    columnDefs: [{
                        ...
                        render: function(data, type, full, meta) {
                            $('#uuid').val(data);
                            $('#uuid_realCost').val(full.uuid_realCost);
                        ...
                        `;
                                ...
                                return `
                                        ...
                                        <a href="javascript:;" type="button" data-uuid_realCost=, $('#uuid_realCost').val()"Persetujuan Po Non Vendor" class="btn btn-warning btn-icon btn-sm" data-bs-toggle="modal" data-bs-target="#kt_modal_1">
