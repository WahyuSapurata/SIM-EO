            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-invoice">
                        ...
                        <input type="hidden" id="uuid_realCost" name="uuid_realCost">
...
@section('script')
    <script>
        ...
        $(document).on('click', '#reload-data', function(e) {
            e.preventDefault();
            $('#uuid_realCost').val($(this).attr('data-uuid_realCost'));
        ...
        $(document).on('click', '#button-reload', function(e) {
            e.preventDefault();
            let uuid = $('#uuid').val();
            let uuid_realCost = $('#uuid_realCost').val();
            ...
            formDataReload.append('uuid_realCost', uuid_realCost); // Menggunakan nilai UUID penjualan
            formDataReload.append('ket', ket);
            control.submitForm('/admin/persetujuan-po/reload-pesetujuannonvendor',
        ...
        const initDatatable = async () => {
            ...
            $('#kt_table_data').DataTable({
                ...
                processing: true,
                ajax: '/admin/persetujuan-po/get-pesetujuannonvendor',
                columns: [{
                        data: null,
                    ...
                    columnDefs: [{
                        ...
                        `;
                                ...
                                return `
                                        ...
                                        <a href="javascript:;" type="button" data-uuid="${data}" data-uuid_realCost="${full.uuid_realCost}" class="btn btn-warning btn-icon btn-sm" id="reload-data" data-bs-toggle="modal" data-bs-target="#kt_modal_1">
        ...
        $('#export-excel').click(function(e) {
            e.preventDefault();
            window.open(`/admin/persetujuan-po/export-pesetujuannonvendor`, "_blank");
        });
    </script>
@endsection
