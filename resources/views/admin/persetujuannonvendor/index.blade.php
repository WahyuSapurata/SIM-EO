...
@section('script')
    <script>
        ...
        $(document).on('click', '.button-update', function(e) {
            ...
            control.overlay_form('Tambah', 'Persetujuan Po');
        })

        $(document).on('click', '.button-reload', function(e) {
            e.preventDefault();
            $.ajax({
                url: '/admin/persetujuan-po/reload-pesetujuannonvendor/' + $(this).attr('data-uuid'),
                method: 'GET',
        ...
        let columnDefs = [{
            ...
            render: function(data, type, full, meta) {
                ...
                <a href="javascript:;" type="button" data-uuid="${data}" data-label="Persetujuan Po" class="btn btn-warning button-reload btn-icon btn-sm">
