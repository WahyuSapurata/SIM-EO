...
@section('script')
    <script>
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            if (type == 'add') {
                control.submitFormMultipartData('/admin/master-data/add-datauser', 'Tambah',
                    'User',
                    'POST');
            } else {
                let uuid = $("input[name='uuid']").val();
                control.submitFormMultipartData('/admin/master-data/update-datauser/' + uuid, 'Update',
                    'User', 'POST');
            }
        });
        ...
        $(document).on('click', '.button-update', function(e) {
            e.preventDefault();
            let url = '/admin/master-data/show-datauser/' + $(this).attr('data-uuid');
            control.overlay_form('Update', 'User', url);
        })

        $(document).on('click', '.button-delete', function(e) {
            e.preventDefault();
            let url = '/admin/master-data/delete-datauser/' + $(this).attr('data-uuid');
        ...
        $('#from_select').change(function() {
            ...
            if (fromSelectValue === 'procurement' || fromSelectValue === 'admin' || fromSelectValue === 'finance') {
